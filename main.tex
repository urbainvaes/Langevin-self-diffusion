...
It is well known,
based on the pioneering work of Sutherland~\cite{sutherland1905lxxv}, Einstein~\cite{einstein1905molekularkinetischen} and Smoluchowski~\cite{von1906kinetischen},
...
which opens the door to the simple Monte Carlo approach presented below in~\eqref{eq:naive_estimator} for its estimation.
...
Effective diffusion, for the Langevin dynamics~\eqref{eq:langevin},
...
The precise formulation of Einstein's relation is then $D^{\gamma}_{\vect e} := \vect e^\t \mat D^{\gamma} \vect e = \beta M^{\gamma}_{\vect e}$.
