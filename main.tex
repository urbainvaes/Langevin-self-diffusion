...
\Cref{fig:effective_diffusion_gle}
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.495\linewidth]{figures/time-gle-4.pdf}
    \includegraphics[width=0.495\linewidth]{figures/time-gle-5.pdf}
    \caption{%
        Sample mean and associated confidence interval for the naive estimator~\eqref{eq:simple_estimator} and improve estimator~\eqref{eq:improved_estimator_gle} for generalized Langevin dynamics,
        estimated from $5000$ ($\gamma = 10^{-4}$) and $500$ ($\gamma = 10^{-5}$) trajectories.
    }
