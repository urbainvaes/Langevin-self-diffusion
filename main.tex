...
\begin{abstract}
    The scaling of the mobility of multi-dimensional Langevin dynamics in a periodic potential as the friction vanishes is unknown for non-separable potentials.
    Calculating the mobility numerically in the underdamped regime is challenging because
