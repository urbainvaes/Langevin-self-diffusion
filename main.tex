...
\begin{lemma}
    ...
    Let
    \[
        D(\mathcal L_{\rm FD}) = \Bigl\{ f \in L^2_0(\kappa): \mathcal L_{\rm FD} f \in L^2_0(\kappa) \Bigr\}.
    \]
    ...
    with $\lVert \e^{t \mathcal L_{\rm FD}} f \rVert \leq \e^{-t} \lVert f \rVert$ for all $f \in L^2_0(\kappa)$.
\end{lemma}
...
\begin{proof}
    ...
    and so it has a limit in $H^1(\mu)$ which necessarily coincides with $\e^{t \mathcal L_{\rm FD}} f$,
    because $L^2(\mu)$ convergence implies almost everywhere convergence of a subsequence.
