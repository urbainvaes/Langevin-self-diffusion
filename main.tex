...
\begin{lemma}
    ...
    There exist constants~$M$ and~$\ell$ such that
    \begin{equation}
        \label{eq:bias}
        ...
        \frac{L \max \{\gamma^{-2}, \gamma^2\}}{\beta \ell^2 T}.
    \end{equation}
\end{lemma}
...
\begin{corollary}
    ...
    There exist constants~$\widehat L$ and~$\widehat \ell$ such that
    \begin{equation}
        \label{eq:bias}
        \forall \gamma \in (0, \infty),
        \quad
        ...
        \leq
        % \frac{L}{\beta T}\int_{0}^{\infty} \exp\bigl(- \ell \theta \min\{\gamma, \gamma^{-1}\}\bigr) \theta \, \d \theta =
        \frac{\widehat L \max \{\gamma^{-2}, 1\}}{\beta \widehat \ell^2 T}.
    \end{equation}
\end{corollary}
\begin{proof}
...
In order to prove the bound~\eqref{eq:refined_bound},
we write
\begin{align*}
