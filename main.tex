...
\begin{proposition}
    ...
    % \]
\end{proposition}
Before giving the proof of this result,
...
In this work,
we show how techniques based on control variates can be employed for improving estimators of dynamical properties,
