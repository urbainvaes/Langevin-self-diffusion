...
We begin by showing that the bias behaves as~$\frac{1}{T}$ in the limit as~$T \to \infty$
and by obtaining estimates on the prefactors in terms of $\gamma$ and $\psi_{\vect e}$.
We then obtain estimates on the variance of $v(T)$,
